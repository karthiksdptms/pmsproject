        ...
        {loading ? (
          ...
          <div className="main" style={{ width: "1200px", height: "700px", position: "relative", top: "40px" }}>
            ...
            <div className="cont" style={{
              ...
              <div className="gphoneno" style={{ position: "relative", left: "400px", bottom: "106px", width: '300px' }}><p style={{ color: "rgb(101, 100, 100)", fontWeight: "900" }}>Skillset Score</p>
                <p style={{ fontWeight: "2900", fontSize: "19px", backgroundColor: "rgb(237, 236, 236)", color: "rgb(45, 44, 44)", width: "250px", padding: "4px", borderRadius: "10px", paddingLeft: "25px" }}>{student.score}</p></div>

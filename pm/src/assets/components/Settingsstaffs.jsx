...
function Settingsstaffs() {
  ...
  useEffect(() => {
    const fetchAdmins = async () => {
      try {
        const response = await axios.get(`${API_BASE_URL}/api/admin/get-admins`);
  ...
  const handleDeleteAdmin = async (id) => {
    ...
    try {
      const response = await axios.delete(
        `${API_BASE_URL}/api/admin/delete-admin/${id}`
      );
    ...
    try {
      if (selectedAdmin) {
        ...
        const response = await axios.put(
          `${API_BASE_URL}/api/admin/edit-admin/${selectedAdmin._id}`,
        formDataToSend,
        {
          headers: {
                  ...
                  {displayedData.map((admin) => (
                    <tr key={admin._id}>
                      ...
                      <td>
                        {admin.profileImage ? (
                          <img
                            src={admin.profileImage ? `${API_BASE_URL}/${admin.profileImage}` : "/default-avatar.png"}
                        alt="Profile"

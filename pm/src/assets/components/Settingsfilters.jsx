...
function Settingsfilters() {
  ...
  const fetchDepartments = async () => {
    try {
      const response = await axios.get(`${API_BASE_URL}/api/filters/getdepartments`);
  ...
  const handleAddDepartment = async () => {
    ...
    try {
      const response = await axios.post(`${API_BASE_URL}/api/filters/adddepartments`, {
        name: newDept,
      });
  ...
  const handleDeleteDepartment = async (id) => {
    try {
      await axios.delete(`${API_BASE_URL}/api/filters/deletedepartments/${id}`);
  ...
  const fetchBatches = async () => {
    try {
      const response = await axios.get(`${API_BASE_URL}/api/filters/getbatch`);
  ...
  const handleAddBatch = async () => {
    ...
    try {
      const response = await axios.post(`${API_BASE_URL}/api/filters/addbatch`, {
        batchName: newBatch,
      });
  ...
  const handleDeleteBatch = async (id) => {
    try {
      await axios.delete(`${API_BASE_URL}/api/filters/deletebatch/${id}`);
  ...
  const fetchAOIs = async () => {
    try {
      const response = await axios.get(`${API_BASE_URL}/api/filters/getaoi`);
  ...
  const handleAddAOI = async () => {
    ...
    try {
      const response = await axios.post(`${API_BASE_URL}/api/filters/addaoi`, {
        aoiName: newAOI,
      });
  ...
  const handleDeleteAOI = async (id) => {
    try {
      await axios.delete(`${API_BASE_URL}/api/filters/deleteaoi/${id}`);

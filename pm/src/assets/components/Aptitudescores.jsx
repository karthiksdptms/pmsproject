...
function Aptitudescores() {
    ...
    const fetchAnswers = async () => {
        try {
            const response = await axios.get(`${API_BASE_URL}/api/answerkey/getscores`);
    ...
    const handlePublish = async (answer) => {
        ...
        try {
            const response = await axios.post(`${API_BASE_URL}/api/students/publish-result`, resultData);
    ...
    const handlePublishSelected = async () => {
        ...
        try {
            const response = await axios.post(`${API_BASE_URL}/api/students/publish-multiple-results`, {
    ...
    const handleDeleteSelected = async () => {
        ...
        try {
            const response = await axios.post(`${API_BASE_URL}/api/students/delete-multiple-results`, {
                results: selectedResults,
            });
